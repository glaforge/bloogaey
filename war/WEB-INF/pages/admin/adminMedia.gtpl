                    ...
                    <div class="post">
                        ...
                        <div class="post-body">
                            ...
                            <fieldset>
                                ...
                                <form action="${blobstore.createUploadUrl('/admin/media/add')}" method="post"
                                      enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-value">
                                            <input type="button" id="fileSelector" class="button"
                                                   value="Choose a file &#187;"/>
                                            &nbsp;
                                            <input type="text" name="fileName" id="fileName" class="text"
                                                   disabled="disabled" size="57">
                                    ...
                                    <div class="form-row form-row-submit">
                                        <div class="form-value"><input type="submit" class="button"
                                                                       value="Upload &#187;"/></div>
                            ...
                            <div id='media-browser'>
                                ...
                                <div id="prevNext">
                                    ...
                                    <input type="button" id="prevButton" class="button" value="&#171; Previous"
                                        ...
                                        ${hasPrev ? '' : 'disabled'}/>
                                    &nbsp;
                                    <input type="text" id="currentPage" class="text"
                                           value="Page ${page + 1} / ${pageCount}" disabled size="8"

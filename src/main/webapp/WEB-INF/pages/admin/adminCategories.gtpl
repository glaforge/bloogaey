                            ...
                            <ul class="nice-list">
                                ...
                                <li>
                                    ...
                                    <form action="/admin/categories/delete/${category.name}" method="post">
                                        <input type="image" src="/images/cross.png" alt="Delete this category?"
                                               align="right">
                                    </form>
                                    <% } %>
                                    <strong>${category.name}</strong> &mdash;
                                    <em>${category.description}</em> &mdash;
                                    <em>(<a href="/category/${category.name}">${request.categoriesCount[category]} posts</a>)
                                    </em>
                                </li>
                                <% } %>
                            </ul>
                            <fieldset>
                                ...
                                <form action="/admin/categories/add" method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="form-value">
                                            ...
                                            <div class="error hidden"
                                                 id="catError">Category name must not be empty</div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-value"><input type="text" name="categoryDescription"
                                                                       class="text" size="70"></div>
                                    ...
                                    <div class="form-row form-row-submit">
                                        <div class="form-value"><input type="submit" class="button" id="submitButton"
                                                                       value="Add category &#187;"/></div>

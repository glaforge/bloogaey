                                ...
                                <form action="/admin/posts/save" method="post">
                                    ...
                                    <table style="width: 95%; margin: 0; padding: 0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-row">
                                                    <div class="form-property form-required">Created <em>(GMT time)</em>
                                                    </div>

                                                    <div class="form-value">
                                                        <input type="text" name="created" id="createdInput" class="text"
                                                               size="16"
                                                               value="${(post ? post.created : new Date()).format('yyyy/MM/dd HH:mm')}">

                                                        <div class="error hidden"
                                                             id="dateInputError">Incorrect date<br>(yyyy/MM/dd HH:mm)
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <div class="form-row">
                                        <div class="form-property form-required"
                                             style="margin-bottom: 8px">Categories</div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-value">
                                            <textarea id="content" rows="10" cols="72"
                                                      name="content">${post ? post.content : ''}</textarea>
                                        </div>

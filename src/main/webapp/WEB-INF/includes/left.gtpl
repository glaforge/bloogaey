    ...
    <div id="sidebar">
        ...
        <div class="box">
            ...
            <div class="box-content">
                <ul class="nice-list">
                    <li><a href="/admin/posts/create">Create new content <img src="/images/add.png" alt="New content"
                                                                              align="right"></a></li>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <ul class="nice-list">
                    ...
                    %>
                    <li>
                        <a href="/category/${category.name}" alt="${category.description}">${category.name} ($count)</a>
                    </li>
                    <% } %>
                </ul>
            </div>
